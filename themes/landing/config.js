const CONFIG = {
  ...
  HEDEAR_BUTTON_2_URL: 'https://bk.aile.eu.org/',

  // 首页大图英雄板块
  HERO_TITLE_1: 'NotionNext',
  HERO_P_1: '快速搭建独立站、轻松放大品牌价值！',
  HERO_BUTTON_1_TEXT: '开始体验',
  HERO_BUTTON_1_LINK: 'https://docs.bk.aile.eu.org',
  HERO_BUTTON_2_TEXT: '了解更多',
  HERO_BUTTON_2_LINK: 'https://docs.bk.aile.eu.org/about',
  ...
  POST_REDIRECT_URL: process.env.NEXT_PUBLIC_POST_REDIRECT_URL || 'https://blog.bk.aile.eu.org', // 重定向网站地址

  NEWSLETTER: process.env.NEXT_PUBLIC_THEME_LANDING_NEWSLETTER || false // 是否开启邮件订阅 请先配置mailchimp功能 https://docs.bk.aile.eu.org/article/notion-next-mailchimp
}
